...
contract change for a row whose subject is one of the 40. `--print-residual` is how you tell the two
...
moves whenever anything is added to any one of the 40 and says nothing about the scale of the
