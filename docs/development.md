...
on the checked-in files rather than guessed at, that is **41 types owning close to six hundred rows** in
...
contract change for a row whose subject is one of the 41. `--print-residual` is how you tell the two
...
moves whenever anything is added to any one of the 41 and says nothing about the scale of the
