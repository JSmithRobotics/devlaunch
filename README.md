...
[![Conda](https://img.shields.io/badge/conda-v0.37.0+fork.2-brightgreen?logo=anaconda)](https://prefix.dev/channels/@jsmithrobotics/jsmithrobotics/packages/devlaunch)
...
```bash
pixi global install --channel https://prefix.dev/jsmithrobotics/jsmithrobotics --channel https://prefix.dev/blooop --channel conda-forge devlaunch=0.37.0+fork.2
```
